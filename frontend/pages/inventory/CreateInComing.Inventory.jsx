...
import { useCreateInventoryIncomingMutation } from '../../redux/api/inventorySlice';
...
const CreateInComingInventory = () => {
  ...
  const [createIncomingLog, { isLoading }] =
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await createIncomingLog({ user_id: userInfo.id, logItems }).unwrap();
